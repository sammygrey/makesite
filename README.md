...
[![Go Report Card](https://goreportcard.com/badge/github.com/YOUR_USERNAME/YOUR_REPONAME)](https://goreportcard.com/report/github.com/sammygrey/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
  ...
  - [x] **_FILL IN THE BLANK_**: `I will use the Caesar Cipher library. The documentation is located at https://github.com/alexjohnj/caesar. My goal is to use it to encrypt the information passed to the HTML template so user's can decode it.`
- [x] **Add, commit, and push to GitHub**.
